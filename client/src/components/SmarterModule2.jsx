  ...
  return (
    <div className="bg-white pt-12 md:pt-16 px-4 sm:px-6 relative -mt-100">
      ...
      <div className="max-w-7xl mx-auto">
        {/* First Row - 3 Cards */}
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-2 sm:mt-3 md:mt-4 lg:mt-6 relative z-10">
        ...
        {/* Second Row - 3 Cards */}
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-8 sm:mt-12 md:mt-16 relative z-10">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mt-8 sm:mt-12 md:mt-16 relative z-10 max-w-4xl mx-auto">
