...
const HowItWorks = () => (
  <section className="w-full min-h-screen bg-gray-100 flex flex-col justify-center px-2 sm:px-4 py-8 sm:py-16 relative">
    <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div>
          ...
          <h2 className="text-[1.2rem] sm:text-[1.5rem] md:text-[2rem] font-medium font-poppins text-black mb-2 leading-tight">
            <span className="md:hidden">
              Accord AI uses a blend of advanced technologies and deep metaphysical understanding to provide meaningful guidance. It communicates through chat — listening, interpreting, and guiding you with care and clarity. Here's how it works:
            </span>
      ...
      {/* Cards Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row items-start justify-center gap-4 sm:gap-4 lg:gap-8 mt-6 sm:mt-8">
        {/* Card 1 */}
        <div className="relative w-full max-w-[300px] sm:w-full md:w-full lg:max-w-[290px] pb-8 sm:pb-10 lg:pb-20 mx-auto">
          ...
          {/* Arrows for desktop */}
          <div className="hidden lg:flex absolute left-[-40px] sm:left-[-60px] lg:left-[-150px] top-[230px] sm:top-[270px] lg:top-[370px] items-center gap-1 sm:gap-2 lg:gap-4">
          ...
          {/* Arrows below for mobile & tablet */}
          <div className="flex lg:hidden justify-center mt-4 gap-2">
            <button className="w-8 h-8 rounded-full border border-blue-700 flex items-center justify-center bg-white hover:bg-blue-50 transition">
        ...
        {/* Card 2 */}
        <div className="bg-white rounded-2xl p-4 sm:p-8 w-full sm:w-full md:w-full lg:w-[550px] h-auto flex flex-col justify-center mx-auto">
          <ul className="space-y-4 sm:space-y-6 text-[#393654] text-base sm:text-lg font-poppins">
        ...
        {/* Card 3 */}
        <div className="bg-black rounded-2xl shadow-lg w-full max-w-[300px] sm:w-[350px] md:w-[290px] h-[280px] sm:h-[320px] md:h-[400px] flex flex-col justify-end items-center overflow-hidden relative mx-auto">
          <img
