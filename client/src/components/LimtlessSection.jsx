...
const LimtlessSection = () => {
  return (
    <section className="bg-white w-full py-8 sm:py-12 md:py-16 px-2 sm:px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6 sm:gap-8 md:gap-10">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 order-1 md:order-none self-center">
          <img
            src="/person-1.png"
            alt="avatar"
        ...
        {/* Right: Subtext */}
        <div className="max-w-sm text-gray-600 text-center sm:text-left md:text-left text-base sm:text-lg md:text-xl lg:text-2xl order-2 md:order-none self-center sm:self-start">
          <p>
